...
1. Create a **granular access token** at [npmjs.com → Access Tokens](https://www.npmjs.com/settings/alfonsobries/tokens) with read/write access to the `expo-native-emoji-picker` package and **bypass 2FA on publish** enabled.
